      ...
      <h1 className="text-[white] text-[25px] font-bold">
        ...
        <div className="containern  p-3">
            <div className="contact w-[70%]  p-5 mx-auto border rounded-lg shadow_border ">
                <h1 className="text-[white] font-bold text-[25px] text-start">Let's Connect</h1>
                <form action="" className="mt-5 p-4 ">
                    {
                        input_data.map(
                            (detail)=>{
                               return (
                                <>
                                <input type={detail.type} name="" id=""  placeholder={detail.placeholder} required   className=" mt-5 bg-transparent border border-[#a09d9d] p-3 w-[100%] rounded-lg"/>
                                </>
                               )
                            }
                        )
